...
public class ZConflictNoSpeculateTest {
	...
	static {
		...
		{
			// 通过反射关闭 speculateMode
			try {
				Field field = EjokerContextDev2Impl.class.getDeclaredField("speculateMode");
				field.setAccessible(true);
				field.set(ejokerContextDev2Impl, false);
			} catch (Exception e) {
		...
		ejokerContextDev2Impl.getEJokerRootDefinitionStore().scanPackage("pro.jiefzz.ejoker.common.context.conflictService");
	...
	public void test2() {
		...
		IBSuper<Integer> ibSuper2 = ejokerContextDev2Impl.get(new TypeRefer<IBSuper<Integer>>() { });
		IBSuper ibSuper3 = ejokerContextDev2Impl.get(IBSuper.class, Integer.class);
		Assertions.assertEquals(ServiceB5.class, ibSuper2.getClass());
		Assertions.assertEquals(ServiceB5.class, ibSuper3.getClass());
		...
		Assertions.assertEquals(ServiceB5.class, ibSuperd.getClass());
	...
	public void test3() {
		...
		Assertions.assertNotEquals(ibSuperx, ibSupery);
